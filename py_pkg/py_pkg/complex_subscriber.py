...
class ComplexSubscriberNode(Node):
    def __init__(self):
        ...
        self.complex_subscriber = self.create_subscription(Complex, "complex_num", self.recieved_callback, 10)
        self.get_logger().info("Complex number subscriber has been started.")
    def recieved_callback(self, msg):
        self.get_logger().info("Complex number received - real: " + str(msg.real) + " imaginary: " + str(msg.imaginary))
def main(args=None):
